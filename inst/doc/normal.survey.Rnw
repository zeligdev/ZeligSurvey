...
\SweaveOpts{results=hide, prefix.string=vigpics/normalsurvey}
...
\title{normal.survey: Survey-Weighted Normal Regression for Continuous Dependent Variables}
